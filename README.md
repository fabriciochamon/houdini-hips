...
Another complete workflow example: kinefx skeleton > apex rig (using autorig builder) > apex animation > exported as USD clip > crowd agent > crowd sim w/ terrain adaptation > solaris.
